//Elabore um programa para manipulação de nomes e idades em um arquivo. Para isso utilize o seguinte menu de opções:

//1 - insere nome e idade

//2 - Conta quantidade de vogais armazenadas no arquivo

//3 - imprima o nome da pessoa mais velha que está armazenada no arquivo. 

//4 - Fim

//Obs: as informações de quantidade de vogais e o nome da pessoa mais velha deve, ser obtidos pela leitura no arquivo e não no momento da leitura dos dados pelo teclado.
